...
class SessionTransportView extends StatefulWidget {
  ...
  const SessionTransportView({Key? key, required this.session}) : super(key: key);
    ...
    return Form(
      ...
      child: Scaffold(
          appBar: AppBar(
            ...
            title:
            FxText.sh1("Schedule Transport", fontWeight: 600,
                color: theme.backgroundColor),
          ),
          floatingActionButton: FloatingActionButton(
              onPressed: () {
                if (!_formKey.currentState!.validate()) {
                  ...
                  TransportInterface().transfer(widget.session.id, putNewOrderRequest);
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      onChanged: (text) => putNewOrderRequest.notes = text,
                                      decoration: InputDecoration(
                                        labelText: "Note",
                                        border: theme.inputDecorationTheme.border,
                                        enabledBorder: theme.inputDecorationTheme.border,
                                ...
                                children: [
                                  Container(
                                    margin: const EdgeInsets.only(
                                        top: 8, left: 8, right: 8),
                                    child: TextFormField(
                                      initialValue: putNewOrderRequest.source.firstName,
                                      onChanged: (text) => putNewOrderRequest.source.firstName = text,
                                      validator: (value) => _validate(value),
                                      decoration: InputDecoration(
                                        labelText: "Name",
                                        border: theme.inputDecorationTheme.border,
                                  ...
                                  Container(
                                    margin: const EdgeInsets.only(
                                        top: 8, left: 8, right: 8),
                                    child: TextFormField(
                                      initialValue: putNewOrderRequest.source.address1,
                                      onChanged: (text) => putNewOrderRequest.source.address2 = text,
                                      validator: (value) => _validate(value),
                                      decoration: InputDecoration(
                                        labelText: "Address1",
                                        border: theme.inputDecorationTheme.border,
                                  ...
                                  Container(
                                    margin: const EdgeInsets.only(
                                        top: 8, left: 8, right: 8),
                                    child: TextFormField(
                                      initialValue: putNewOrderRequest.source.address2,
                                      onChanged: (text) => putNewOrderRequest.source.address2 = text,
                                      decoration: InputDecoration(
                                        labelText: "Address2",
                                        border: theme.inputDecorationTheme.border,
                                  ...
                                  Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      onChanged: (text) => putNewOrderRequest.source.city = text,
                                      validator: (value) => _validate(value),
                                      decoration: InputDecoration(
                                        labelText: "City",
                                        border: theme.inputDecorationTheme.border,
                                  ...
                                  Container(
                                      ...
                                      child: FxListText(label: 'State',
                                          initialValue: putNewOrderRequest.source.state,
                                          values: USStates.getAllAbbreviations(),
                                          onListChanged: (newState) {
                                            putNewOrderRequest.source.state = newState;
                                          },
                                          validator: (value) => _validate(value))
                                  ),
                                  Container(
                                    margin: const EdgeInsets.only(
                                        top: 8, left: 8, right: 8),
                                    child: TextFormField(
                                      initialValue: putNewOrderRequest.source.zipCode,
                                      onChanged: (text) => putNewOrderRequest.source.zipCode = text,
                                      validator: (value) => _validate(value),
                                      decoration: InputDecoration(
                                        labelText: "Zipcode",
                                        border: theme.inputDecorationTheme.border,
                                  ...
                                  Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      onChanged: (text) => putNewOrderRequest.source.phone = text,
                                      validator: (value) => _validate(value),
                                      decoration: InputDecoration(
                                        labelText: "Phone",
                                        border: theme.inputDecorationTheme.border,
                                ...
                                children: [
                                  Container(
                                    margin: const EdgeInsets.only(
                                        top: 8, left: 8, right: 8),
                                    child: TextFormField(
                                      initialValue: putNewOrderRequest.destination.firstName,
                                      onChanged: (text) => putNewOrderRequest.destination.firstName = text,
                                      validator: (value) => _validate(value),
                                      decoration: InputDecoration(
                                        labelText: "Name",
                                        border: theme.inputDecorationTheme.border,
                                  ...
                                  Container(
                                    margin: const EdgeInsets.only(
                                        top: 8, left: 8, right: 8),
                                    child: TextFormField(
                                      initialValue: putNewOrderRequest.destination.address1,
                                      onChanged: (text) => putNewOrderRequest.destination.address2 = text,
                                      validator: (value) => _validate(value),
                                      decoration: InputDecoration(
                                        labelText: "Address1",
                                        border: theme.inputDecorationTheme.border,
                                  ...
                                  Container(
                                    margin: const EdgeInsets.only(
                                        top: 8, left: 8, right: 8),
                                    child: TextFormField(
                                      initialValue: putNewOrderRequest.destination.address2,
                                      onChanged: (text) => putNewOrderRequest.destination.address2 = text,
                                      decoration: InputDecoration(
                                        labelText: "Address2",
                                        border: theme.inputDecorationTheme.border,
                                  ...
                                  Container(
                                    margin: const EdgeInsets.only(
                                        top: 8, left: 8, right: 8),
                                    child: TextFormField(
                                      initialValue: putNewOrderRequest.destination.city,
                                      onChanged: (text) => putNewOrderRequest.destination.city = text,
                                      validator: (value) => _validate(value),
                                      decoration: InputDecoration(
                                        labelText: "City",
                                        border: theme.inputDecorationTheme.border,
                                  ...
                                  Container(
                                      margin: const EdgeInsets.only(
                                          top: 8, left: 8, right: 8),
                                      child: FxListText(label: 'State',
                                          initialValue: putNewOrderRequest.destination.state,
                                          values: USStates.getAllAbbreviations(),
                                          onListChanged: (newState) {
                                            putNewOrderRequest.destination.state = newState;
                                          },
                                          validator: (value) => _validate(value))
                                  ),
                                  Container(
                                    margin: const EdgeInsets.only(
                                        top: 8, left: 8, right: 8),
                                    child: TextFormField(
                                      initialValue: putNewOrderRequest.destination.zipCode,
                                      onChanged: (text) => putNewOrderRequest.destination.zipCode = text,
                                      validator: (value) => _validate(value),
                                      decoration: InputDecoration(
                                        labelText: "Zipcode",
                                        border: theme.inputDecorationTheme.border,
                                  ...
                                  Container(
                                    margin: const EdgeInsets.only(
                                        top: 8, left: 8, right: 8),
                                    child: TextFormField(
                                      initialValue: putNewOrderRequest.destination.phone,
                                      onChanged: (text) => putNewOrderRequest.destination.phone = text,
                                      validator: (value) => _validate(value),
                                      decoration: InputDecoration(
                                        labelText: "Phone",
                                        border: theme.inputDecorationTheme.border,
