...
class ListingNewDialog extends StatefulWidget {
  ...
  const ListingNewDialog({Key? key, required this.onSubmit, required this.initOfferPrice, required this.marketplaces}) : super(key: key);
  @override
...
class _ListingNewDialogState extends State<ListingNewDialog> {
  ...
  void initState() {
    ...
    listingNewReq = listingNewReq = ListingNewReq(widget.initOfferPrice, DateTime.now(), []);
  }
              ...
              child: Column(
                ...
                children: <Widget>[
                    ...
                    children: <Widget>[
                      Expanded(
                        child: RichText(
                          text: TextSpan(
                              style:
                              FxTextStyle.b1(fontWeight: 500,
                                  letterSpacing: 0.2),
                              children: const <TextSpan>[
                                TextSpan(
                                    text: "Please complete up listing detail"),
                              ]),
                        ),
                      )
                    ],
                  ...
                  TextFormField(
                    ...
                    onChanged: (value) =>
                    listingNewReq.offerPrice = int.parse(value),
