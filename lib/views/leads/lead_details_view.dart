                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ListTile(
                          title: FxText.sh2("Asking price too high", fontWeight: 600),
                        ...
                        ListTile(
                          title: FxText.sh2("Bad carfax/Title Issue", fontWeight: 600),
                          contentPadding: const EdgeInsets.all(0),
                          dense: true,
                          leading: Radio(
                            value: 2,
                        ...
                        ListTile(
                          title: FxText.sh2("Already Sold", fontWeight: 600),
                          contentPadding: const EdgeInsets.all(0),
                          dense: true,
                          leading: Radio(
                            value: 3,
                        ...
                        ListTile(
                          title: FxText.sh2("High Mileage", fontWeight: 600),
                          contentPadding: const EdgeInsets.all(0),
                          dense: true,
                          leading: Radio(
                            value: 4,
