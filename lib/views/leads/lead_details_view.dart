...
class _LeadDetailsViewState extends State<LeadDetailsView> {
  ...
  void initState() {
    ...
    followupDateController.text = DateFormat('yyyy-MM-dd').format(selectedDate!);
  }
        ...
        builder: (context, AsyncSnapshot<Lead?> snapshot) {
          ...
          return Scaffold(
              ...
              appBar: AppBar(
                ...
                title: FxText.sh1(lead!.name, fontWeight: 600, color: theme.backgroundColor,),
              ),
                    ...
                    ListTile(
                      ...
                      title: InkWell(
                        onTap: () {
                          ...
                          Navigator.pushNamed(context, LeadScheduleView.routeName, arguments: lead);
                        },
                            ...
                            children: [
                              FxButton.rounded(
                                  onPressed: () {
                                    Navigator.pop(context);
                                    Navigator.pop(context);
                                    BackendInterface().putLeadUnAnswered(lead!.id, _sms!, _voice!);
                                  },
                                  child: FxText.button("Confirm",
                                    color: theme.colorScheme.onPrimary,)),
                              FxButton.rounded(
